...
const questions: Question[] = [
  ...
  { id: 2, text: '今日は和食の気分？それとも洋食の気分？', options: [ { id: 3, text: '和食' }, { id: 4, text: '洋食' } ] },
  ...
  { id: 7, text: '今すぐ食べたい？それとも少し待っても大丈夫？', options: [ { id: 13, text: '今すぐ食べたい' }, { id: 14, text: '少し待っても大丈夫' } ] },
];
...
export default function QuestionFlowPage() {
  ...
  const handleSelect = (option: Option) => {
    ...
    setTimeout(() => {
      ...
      if (nextQ) {
        ...
        console.log('回答履歴:', [...history, option]);
  ...
  return (
    <div className="min-h-screen bg-gradient-to-b from-orange-100 via-orange-200 to-orange-300 flex items-center justify-center overflow-hidden">
      <div
        key={key}
        className={`max-w-md w-full bg-white rounded-2xl shadow-lg p-6 relative border-2 border-orange-300
