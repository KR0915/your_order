...
import { getAllTest2, createTest2, deleteTest2 } from "@/app/services/test2Service";
import { Test2 } from "@/app/types";
import { useRouter } from "next/navigation";

export default function Test2Page() {
  const [items, setItems] = useState<Test2[]>([]);
  ...
  const handleCreate = async () => {
    ...
    try {
      const createdItem = await createTest2(newName);
  ...
  console.log("❗️ Server render /test2");

  return (
    <div className="p-4">
      <h1 className="text-2xl font-bold mb-4">Test2 一覧</h1>
